(function (g) {
  ...
  "meta": {
    ...
    "homeDesc": "Amigura — El yapımı, organik ipliklerle örülen lüks amigurumi koleksiyonu. Trendyol üzerinden güvenle sipariş verin.",
  ...
  "products": {
    ...
    "lead": "Büyücülük evreninden dört ikonik karakter — ilmek ilmek el emeği. Favorinizi seçin ve Trendyol üzerinden güvenle sipariş verin.",
    "harryPotter": {
  ...
  "reviews": {
    ...
    "dotAria": "Yorum {n}",
    "r1": {
      "quote": "Kızım her gece kucuğuna basıyor. Dokusu gerçekten farklı — mağaza oyuncağı gibi değil, sıcak ve yumuşak.",
      "name": "Elif K.",
      "city": "İstanbul",
      "product": "Harry Potter Amigurumi"
    },
    "r2": {
      "quote": "Eşime doğum günü hediyesi aldım. Paketleme özenliydi; Trendyol'dan sipariş vermeme rağmen butik hissi verdi.",
      "name": "Mert A.",
      "city": "Ankara",
      "product": "Hermione Granger Amigurumi"
    },
    "r3": {
      "quote": "Malefiz figürünün boynuz detayı ve pelerini görünce hayran kaldık. Koleksiyon parçası olarak vitrinde duruyor.",
      "name": "Zeynep D.",
      "city": "İzmir",
      "product": "Malefiz Amigurumi"
    },
    "r4": {
      "quote": "Oğlum 3 yaşında, güvenli göz detayı için özellikle tercih ettik. Ronald tam istediğimiz gibiydi.",
      "name": "Ayşe T.",
      "city": "Bursa",
      "product": "Ronald Weasley Amigurumi"
    },
    "r5": {
      "quote": "Harry ve Hermione setini aldık — renk uyumu ve işçilik mükemmel. Hediye notu da çok tatlıydı, teşekkürler İrem Hanım.",
      "name": "Can Y.",
      "city": "Antalya",
      "product": "Harry Potter Amigurumi"
    }
  ...
  "modal": {
    ...
    "handoffLead": "Siparişiniz Trendyol'un güvenli altyapısı üzerinden tamamlanır. Amigura olarak paketleme ve kalite sürecinden sorumluyuz.",
    ...
    "careSafety": "Güvenlik",
    "ok": "Tamam",
    "quickViewCta": "Trendyol'da Gör",
    "quickViewOrganic": "Organik Pamuk",
    "quickViewCareTitle": "Bakım & Boyut",
    "quickViewTrust1": "Trendyol ile güvenli ödeme",
    "quickViewTrust2": "Hızlı & korumalı kargo",
