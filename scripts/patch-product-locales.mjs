...
const REVIEWS_TR = {
  lead:
    "Barbie'den Sonic'e, el rgs antalardan nostaljik telefonlara  ilmek ilmek el eme?i. Favorinizi sein ve Trendyol zerinden gvenle sipari? verin.",
  r1: {
    quote:
      "K?z?m Elsa figrn her gece kucu?una bas?yor. Dokusu gerekten farkl?  ma?aza oyunca?? gibi de?il, s?cak ve yumu?ak.",
    name: "Elif K.",
    city: "?stanbul",
  ...
  r3: {
    quote:
      "Wednesday figrnn sa rgs ve ifadesi harika. Koleksiyon paras? olarak vitrinde duruyor.",
    name: "Zeynep D.",
    city: "?zmir",
  ...
  r4: {
    quote:
      "O?lum 3 ya??nda; Olaf'?n yumu?ak dokusu ve gvenli gz detay? iin tercih ettik. Tam istedi?imiz gibiydi.",
    name: "Ay?e T.",
    city: "Bursa",
  ...
  r5: {
    quote:
      "Maui figrnn i?ili?i mkemmel. Hediye notu da ok tatl?yd?, te?ekkrler ?rem Han?m.",
    name: "Can Y.",
    city: "Antalya",
...
const REVIEWS_EN = {
  lead:
    "From Barbie to Sonic, crochet bags to nostalgic phones  stitch by stitch handcraft. Pick your favourite and order safely on Trendyol.",
  r1: {
    quote:
      "My daughter hugs her Elsa figure every night. The texture is so different from store toys  warm and soft.",
    name: "Elif K.",
    city: "Istanbul",
    product: "Elsa Amigurumi",
  },
  ...
  r4: {
    quote:
      "We chose Olaf for our 3-year-old  soft touch and safe embroidered eyes. Exactly what we hoped for.",
    name: "Ayse T.",
    city: "Bursa",
    product: "Olaf Amigurumi",
  },
  r5: {
    quote:
      "Maui's craftsmanship is excellent. Lovely gift note too  thank you Irem.",
    name: "Can Y.",
    city: "Antalya",
    product: "Maui Amigurumi",
  },
